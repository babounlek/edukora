...
from .models import ParrainageRecompense, Plan, Subscription


@admin.register(Plan)
class PlanAdmin(admin.ModelAdmin):
    list_display = ["name", "cursus", "price", "duration_mode", "duration_days", "is_active"]
    list_filter = ["is_active", "duration_mode", "cursus"]
    search_fields = ["name"]
