...
class AuditCouvertureProgrammeCommandTests(TestCase):
    ...
    programme.management.commands.audit_couverture_programme. Les trois sections
    (périmètre, contenu, ingestion bloquée) sont testées indépendamment - chacune doit
    fonctionner (et ne rien écrire) même quand les deux autres sont hors sujet."""
