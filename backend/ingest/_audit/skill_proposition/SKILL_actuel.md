...
- Ne jamais laisser un `$` littéral (variable PHP, référence de tableur, symbole monétaire) hors d'un span ou bloc de code ni échappé : voir « Le caractère `$` hors formule doit toujours être protégé »
