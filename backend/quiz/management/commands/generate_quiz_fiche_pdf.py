...
class Command(BaseCommand):
    help = (
        ...
        "QuizSession, terminée ou non (voir quiz.views.quiz_fiche_pdf) - déclenchée par "
        "quiz.views.quiz_fiche_pdf via queue_quiz_fiche_pdf_generation. Ne tourne jamais "
